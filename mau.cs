...
namespace UEHGreen
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (playAgain)
            {
                ...
                intro.DisplayIntro();  // Display the intro each time before starting the game
    ...
    @"  /  | ",
            ...
            void RenderHurdles(bool renderEnter)
            {
                ...
                if (key != ConsoleKey.Y)
                {
                    playAgain = false;  // Exit the loop and the game if the player chooses not to play again
                }
                Console.Clear();  // Clear the screen before showing the intro again
            }
